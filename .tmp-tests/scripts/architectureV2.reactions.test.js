...
// Schema: qvc-v2
import { buildReactionEnvelope, reduceReactionRecords, resolveReactionDisplay, isReactionEnvelope as isV2ReactionEnvelope, } from '../src/services/architectureV2/reactions.js';
const assert = {
    equal: (a, b) => {
        if (a !== b)
...
const reaction = (publisherName, walletAddress, state, updated, signature, targetId = 'qvc-v2-video-abc12345', targetType = 'video') => {
